...
$sd_hasEmail = in_array('email', $sd_columns);
...
// Fetch manuscript details (latest version)
...
$query = "
    SELECT mr.*, pw.project_title, s.$students_first_col AS first_name, s.$students_last_col AS last_name, 
           " . ($sd_hasGroupCode ? "sd.group_code" : "NULL AS group_code") . ",
           " . ($sd_hasEmail ? "sd.email" : "NULL AS email") . "
    ...
    " . ($sd_hasGroupCode || $sd_hasEmail ? "LEFT JOIN student_details sd ON s.$students_pk COLLATE utf8mb4_unicode_ci = sd.student_id COLLATE utf8mb4_unicode_ci" : "") . "
    WHERE mr.id = ?
";
...
$versionsQuery = $conn->prepare("SELECT mr.*, s.$students_first_col AS first_name, s.$students_last_col AS last_name 
    FROM manuscript_reviews mr 
    INNER JOIN students s ON mr.student_id COLLATE utf8mb4_unicode_ci = s.$students_pk COLLATE utf8mb4_unicode_ci 
    WHERE mr.project_id = ? 
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container-fluid py-4">
            ...
            <!-- Version History placed above like PlagScan -->
                        ...
                        <div class="row">
                            <?php foreach ($allVersions as $index => $version): ?>
                                <div class="col-lg-4 col-md-6 mb-3">
                                    <div class="card h-100 <?php echo $version['id'] == $manuscript['id'] ? 'border-primary' : 'border-secondary'; ?>">
                                        <div class="card-body d-flex flex-column">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <h6 class="mb-0">Version <?php echo isset($version['version']) ? $version['version'] : '1'; ?></h6>
                                                <?php if ($version['id'] == $manuscript['id']): ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if (!empty($version['grammarian_notes'])): ?>
                                                <div class="mt-2">
                                                    <small class="text-muted">
                                                        <strong>Notes:</strong> <?php echo htmlspecialchars(substr($version['grammarian_notes'], 0, 100)) . (strlen($version['grammarian_notes']) > 100 ? '...' : ''); ?>
                                                    </small>
                                                </div>
                                            <?php endif; ?>
                                            </div>
                        ...
                        <form method="POST" enctype="multipart/form-data" id="reviewForm">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="4" 
                                    placeholder="Provide detailed grammar feedback and suggestions..." required disabled><?php echo htmlspecialchars($manuscript['grammarian_notes']); ?></textarea>
                                <div class="form-text">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button class="btn btn-submit d-none" id="saveBtn" type="submit" name="submit_review" onclick="return confirmReview()">
            ...
            <!-- Version History (moved above) removed duplicate block -->
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setDisabled(disabled) {
        ...
        inputs.forEach(el => {
            if (el.name === 'status' || el.name === 'notes' || el.name === 'reviewed_file') {
