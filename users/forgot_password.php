...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    ...
    if (empty($email)) {
        ...
        $stmt = $conn->prepare("SELECT id FROM employees WHERE email = ? UNION SELECT id FROM student_details WHERE email = ?");
                ...
                if ($time_diff < 60) { // 60 seconds = 1 minute
                    ...
                    if ($stmt->execute()) {
                        ...
                        try {
                            ...
                            $mail->Body = "Dear User,<br><br>Please click the following link to reset your password:<br><a href='https://src-captrack.com//management_system/users/reset_password.php?token=$reset_token'>Reset Password</a><br><br>This link will expire in 1 hour.<br><br>Thank you!";
                            $mail->AltBody = "Dear User,\n\nPlease visit the following link to reset your password:\nhttps://src-captrack.com//management_system/users/reset_password.php?token=$reset_token\n\nThis link will expire in 1 hour.\n\nThank you!";
