...
// Get available years for the dropdown (only for dean-published works)
$years_sql = "SELECT DISTINCT year FROM books WHERE status = 'verified' AND published_by_dean = 1 ORDER BY year DESC";
